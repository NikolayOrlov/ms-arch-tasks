...
public class GenericExceptionHandler {
    ...
    public ResponseEntity<?> handleCartException(final Exception ex, final WebRequest request) {
        return new ResponseEntity<>("Cart: %s".formatted(ex.getMessage()), HttpStatus.BAD_REQUEST);
    }
}
